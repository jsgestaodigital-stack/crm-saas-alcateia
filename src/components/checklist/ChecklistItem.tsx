...
const TASK_TIPS: Record<string, string> = {
  ...
  "2-2": "Use o Agente GRank para manter contexto de cada cliente",
  ...
  "6-7": "Use GRank AI para criar descrições otimizadas para SEO",
  ...
  "6-11": "Use GRank AI para criar textos persuasivos",
