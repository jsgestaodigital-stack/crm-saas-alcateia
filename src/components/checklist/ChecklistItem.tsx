...
const TASK_TIPS: Record<string, string> = {
  ...
  "2-2": "Use o Agente Alcateia para manter contexto de cada cliente",
  ...
  "6-7": "Use Alcateia para criar descrições otimizadas para SEO",
  ...
  "6-11": "Use Alcateia para criar textos persuasivos",
