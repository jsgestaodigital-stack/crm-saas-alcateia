...
interface AgenteRelatorioModalProps {
  trigger?: ReactNode;
  onReportGenerated?: (report: string) => void;
}

export function AgenteRelatorioModal({ trigger, onReportGenerated }: AgenteRelatorioModalProps) {
  const { derived, isAdmin } = useAuth();
