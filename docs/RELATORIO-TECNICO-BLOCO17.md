...
## G-Rank CRM — Sistema Multi-Tenant para Agências de Google Meu Negócio
...
O **G-Rank CRM** é um SaaS multi-tenant desenvolvido em React + TypeScript + Supabase, voltado para **agências que gerenciam perfis do Google Meu Negócio**. O sistema oferece:
